...
const Preferences = {
    ...
    THEMES: {
        denim: {
            ...
            sidebarTextHoverBg: '#243b7a',
            sidebarTextActiveBorder: '#c9a227',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#16244b',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#111d3e',
            ...
            mentionBj: '#c9a227',
            mentionColor: '#192a57',
            centerChannelBg: '#f7f9fc',
            centerChannelColor: '#1f2937',
            newMessageSeparator: '#c9a227',
            linkColor: '#243b7a',
            buttonBg: '#192a57',
            buttonColor: '#ffffff',
            errorTextColor: '#d24b4e',
            mentionHighlightBg: '#f4e7aa',
            mentionHighlightLink: '#192a57',
            codeTheme: 'github',
        },
        sapphire: {
            type: 'Sapphire',
