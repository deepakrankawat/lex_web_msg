        ...
        <div className='extraContentBeforeSettingList'>
            <SectionNotice
                ...
                text={intl.formatMessage({
                    ...
                    defaultMessage: 'You\'re missing important message and call notifications from Lexocrates Connect. Lexocrates Connect notifications are disabled by this browser.',
                })}
                primaryButton={{
                    text: intl.formatMessage({
